...
doxygen_root = "doc/doxygen" # this is just a convenience variable
doxylink = {
    "Hello": (  # "Hello" is the role name that you can later use in sphinx to reference this doxygen documentation (see below)
        f"{doxygen_root}/Hello/html/tagfile.xml", # the first parameter of this tuple is the tagfile
        f"{doxygen_root}/Hello/html", # the second parameter of this tuple is a relative path pointing from
